...
from limo.src.dataset.limo_datset import get_dataset


class LimoDataModule(LightningDataModule):
    """
    LightningDataModule for the Limo dataset.
    """
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        if self.data_train is None and self.data_val is None and self.data_test is None:
            ...
            self.data_val = splits.get("val")
            self.data_test = splits.get("test")
